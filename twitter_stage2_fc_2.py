...
def parse_option():
    ...
    parser.add_argument("-img_path", type=str,
                        default='data/log/multi_cased_L-12_H-768_A-12/twitter/img_best.pth',
                        metavar='PATH')
    parser.add_argument("-text_path", type=str,
                        default='data/log/multi_cased_L-12_H-768_A-12/twitter/text_best.pth',
                        metavar='PATH')
...
def main():
    ...
    if args.img_path:
        ...
        pretrain_dict = torch.load(args.img_path)['model']
        model_dict = model_img.state_dict()
        pretrain_dict = {
            k: v
        ...
        model_img.load_state_dict(model_dict)
    ...
    fc_checkpoint=torch.load('data/log/multi_cased_L-12_H-768_A-12/twitter/fc.pth')
    fc = LinearEmbed(2816, 2).eval()  # 2048+ 768
    fc.load_state_dict(fc_checkpoint['model'])
    ...
    print('metrics: acc, prec_0, rec_0, f_0, prec_1, rec_1, f_1' )
